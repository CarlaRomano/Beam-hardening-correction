...
GPU-accelerated by Robert Haase (rhaase@mpi-cbg.de). In order to run the adapted version, activate the CLIJ and CLIJ2 update sites in your Fiji (check here how to https://clij.github.io/).
